...
MODEL_FILE_NAME="../models/20190105_CNN_dense.h5"
MAXTRAIL=5000
...
if __name__=="__main__":
	...
	while trail<MAXTRAIL:
		...
		# pyplot.imshow([[y[0] for y in x] for x in initState])
		# pyplot.show()
		# input()
		state=initState
		statesForTrain,actions,rewards,nextStates=[],[],[],[]
		...
		while not done and step<20:
			...
			action=None
			if np.random.random()< max(0.1,0.8/(1+0.001*trail)): # some naive hurestic
